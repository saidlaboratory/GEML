...
`ANON-PAPER-SNAPSHOT` in the anonymous review workspace, on a machine without the public
...
Writing-order step 3, measured on 2026-07-30 at snapshot `ANON-PAPER-SNAPSHOT`:
