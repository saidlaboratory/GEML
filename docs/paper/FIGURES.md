...
| F3 | Compact GINE+-style architecture and fair-control interface: ordered/directed edge embedding, three layers, pooling, symmetric vs directional heads | architecture contract and frozen model config | Goal 6 model/config/checkpoint hashes | merge-pending |
