...
Drive folder `phase-b-20260731-53a34d2` is the authoritative Phase-B package.  It
...
The old local Goal 6 archive for commit `68556bd` is not uploaded as a separate
authoritative artifact.  It is scientifically superseded by, and represented inside,
the final results archive for runtime commit `53a34d2`.  The compact ledger therefore
...
by this inventory.  Before deleting any local copy, verify the Drive folder by
