...
The authoritative repository snapshot used for this ledger is the anonymous review
snapshot `ANON-CURRENT-SNAPSHOT`. The GPU package was produced from runtime source
snapshot `ANON-PHASE-B-SNAPSHOT` and is not silently substituted for the repository's
older Phase-A documentation.
