...
#   GEML_REPO_URL   clone URL for the anonymous review snapshot
#   GEML_COMMIT     the supplied anonymous source snapshot reference to check
#                   out when the source was obtained from an actual anonymous
#                   Git remote; downloaded source directories may omit Git metadata
# Optional:
